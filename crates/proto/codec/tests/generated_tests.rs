...
use reallyme_codec_proto::generated::{
    proto::reallyme::codec::v1::{
        ...
        CodecCanonicalizationError, CodecDagCborVerifyCidResult, CodecError, CodecErrorReason,
        CodecKeyMaterialKind, CodecMulticodecSpec, CodecMultiformatError, CodecMultikeyParseResult,
        CodecPemDecodeResult, CodecPemError, CodecTag,
    },
    CODEC_PROTO_PACKAGE,
};
...
fn error_reason_enum_value_is_stable() {
    ...
    assert_eq!(
        CodecErrorReason::CODEC_ERROR_REASON_BACKEND_MALFORMED_PROTOBUF.to_i32(),
        501
    );
}
...
#[test]
fn malformed_codec_error_payloads_decode_as_backend_malformed_protobuf() {
    for payload in [
        vec![0xff],
