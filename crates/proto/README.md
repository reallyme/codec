...
codec errors and fixed-shape codec result messages used by services and
...
```toml
[dependencies]
reallyme-codec-proto = { version = "0.2.2", features = ["generated"] }
```
...
belongs to `reallyme-codec::operation_contract`, which accepts one
