...
const codecPackageVersion = "0.1.20";
const codecProtoPackageVersion = "0.1.20";
...
assertContains(".github/workflows/protobuf-ci.yml", "git diff --exit-code -- proto crates/proto/codec/src/generated packages/codec/src/proto/generated gen");
assertContains(
...
assertContains("packages/kotlin-codec/README.md", "me.really:codec:0.1.20");
...
assertContains("packages/android-codec/README.md", "me.really:codec-android:0.1.20");
...
assertContains("README.md", "me.really:codec:0.1.20");
...
assertContains("proto/reallyme/codec/v1/codec.proto", "message CodecMulticodecSpec");
assertContains("proto/reallyme/codec/v1/codec.proto", "message CodecMultikeyParseResult");
assertContains("proto/reallyme/codec/v1/codec.proto", "message CodecPemDecodeResult");
assertContains("proto/reallyme/codec/v1/codec.proto", "message CodecDagCborVerifyCidResult");
